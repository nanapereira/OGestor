...
export const CompetenciaDeleteDialog = (props: ICompetenciaDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="oGestorApp.competencia.delete.question">
        <Translate contentKey="oGestorApp.competencia.delete.question" interpolate={{ id: competenciaEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-competencia" color="danger" onClick={confirmDelete}>
